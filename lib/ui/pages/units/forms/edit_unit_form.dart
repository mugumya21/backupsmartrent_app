...
class _EditUnitFormState extends State<EditUnitForm> {
  ...
  void initState() {
    ...
    super.initState();
    roomNumberController.text = widget.unitModel.name.toString();
    sizeController.text = widget.unitModel.squareMeters.toString();
    amountController.text = widget.unitModel.amount.toString();
    descriptionController.text = widget.unitModel.description.toString();
    currencyModel = widget.unitModel.currencyModel;
    periodModel = widget.unitModel.periodModel;
    unitTypeModel = widget.unitModel.unitTypeModel;
    floorModel = widget.unitModel.floorModel;
        ...
        child: Column(
          children: [
            BlocListener<UnitFormBloc, UnitFormState>(
              ...
              child: FormTitle(
                name: '${widget.isUpdate ? "Edit" : "Edit"}  Unit',
                ...
                onSave: () {
                  ...
                  context.read<UnitFormBloc>().add(UpdateUnitEvent(
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  BlocBuilder<UnitTypeBloc,
                                      UnitTypeState>(
                                    builder: (context, state) {
                                      if (state.status ==
                                          UnitTypeStatus.initial) {
                                        context.read<UnitTypeBloc>().add(
                                            LoadAllUnitTypesEvent(
                                                widget.property.id!));
                                      }
                                      if (state.status ==
                                        ...
                                        return Expanded(
                                          child: CustomApiGenericDropdown<
                                              UnitTypeModel>(
                                            defaultValue: state.unitTypes!.firstWhere(
                                                  (unitType) => unitType.id == widget.unitModel.unitTypeModel!.id,
                                    ...
                                    builder: (context, state) {
                                      ...
                                      if(state.status ==  FloorStatus.success){
                                        return Expanded(
                                          child: CustomApiGenericDropdown<
                                              FloorModel>(
                                            defaultValue: state.floors!.firstWhere(
                                                  (floor) => floor.id == widget.unitModel.floorModel!.id,
                                              orElse: () => floorModel!,
                                            ),
                                            hintText: 'Floor',
                              ...
                              BlocBuilder<PeriodBloc, PeriodState>(
                                builder: (context, state) {
                                  ...
                                  (period) => period.id == widget.unitModel.periodModel!.id,
                                  orElse: () => periodModel!,
                                      ),
                                    hintText: 'Period',
                                ...
                                builder: (context, state) {
                                  ...
                                  if (state.status == CurrencyStatus.success) {
                                    currencyModel =
                                      ...
                                      (currency) => currency.code == widget.unitModel.currencyModel!.code.toString(),
                                      // orElse: () => null as CurrencyModel,
                                    );
                                  }
                                  return CustomApiGenericDropdown<
